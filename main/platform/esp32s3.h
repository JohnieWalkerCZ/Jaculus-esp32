...
struct PlatformInfo {
    ...
    struct PinConfig {
        ...
        static inline const std::unordered_map<int, std::pair<int, int>>
            ANALOG_PINS = {
                {1, {1, ADC1_GPIO1_CHANNEL}}, {2, {1, ADC1_GPIO2_CHANNEL}},
                {3, {1, ADC1_GPIO3_CHANNEL}}, {4, {1, ADC1_GPIO4_CHANNEL}},
                {5, {1, ADC1_GPIO5_CHANNEL}}, {6, {1, ADC1_GPIO6_CHANNEL}},
                {7, {1, ADC1_GPIO7_CHANNEL}}, {8, {1, ADC1_GPIO8_CHANNEL}},
                {9, {1, ADC1_GPIO9_CHANNEL}}, {10, {1, ADC1_GPIO10_CHANNEL}}};
